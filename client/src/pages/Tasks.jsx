    ...
    return (
        <div className="h-screen flex flex-col justify-center mx-10">
                            ...
                            <tbody>
                                {tasks.map((task) => (
                                    <tr key={task.id}>
                                        ...
                                        <td>
                                            <button
                                                className="btn btn-outline btn-xs hover:btn-info hover:!text-white"
                                                onClick={() =>
                                                    showEmployeesPanel(task)
                                                }>
                                                consulter
                                            </button>
                                        </td>
                                        <td>
                                            <button
                                                className="btn btn-outline btn-xs hover:btn-error hover:!text-white"
                                                onClick={() =>
                                                    removeTask(task.id)
                                                }>
                                                supprimer
            ...
            {employeesPanel !== false && (
                <EmployeesListing
                    taskId={employeesPanel.id}
                    employees={employeesPanel.employees}
                    setter={showEmployeesPanel}
